...
var MobileMenu = function () {
    function MobileMenu() {
        ...
        this.menuIcon1 = (0, _jquery2.default)(".site-header__menu-icon");
...
var _createClass = function () { function defineProperties(target, props) { for (var i = 0; i < props.length; i++) { var descriptor = props[i]; descriptor.enumerable = descriptor.enumerable || false; descriptor.configurable = true; if ("value" in descriptor) descriptor.writable = true; Object.defineProperty(target, descriptor.key, descriptor); } } return function (Constructor, protoProps, staticProps) { if (protoProps) defineProperties(Constructor.prototype, protoProps); if (staticProps) defineProperties(Constructor, staticProps); return Constructor; }; }(); /* need to have jquery in node_modules folder */
    ...
    _createClass(StickyHeader, [{
        ...
        value: function createHeaderWaypoint() {
            ...
            new Waypoint({
                ...
                // expecting a js native DOM element, current is a jquery object
                // the first object in the array is a js native DOM element.
